...
def admin_sublinks():
  ...
  if user.lesson_admin_organizations():
    links.append(("/admin/lessons/", "lessons", [("/organization/%s/admin/lessons/" % organization.oid, organization.name) for organization in user.lesson_admin_organizations()]))
  if False: # TODO
